...
router.post('/api/link', (req: Request, res: Response) => { linkController.create(req, res)});
router.get('/api/link', (req: Request, res: Response) => { linkController.getLinks(req, res)});
router.delete('/api/link/:id', (req: Request, res: Response) => { linkController.delete(req, res)});
